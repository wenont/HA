...
\ihead{Softwaretechnik WS 2020/21 \\ Tutorium 100 \\\today}
...
\begin{table}[h!]
	\begin{tabular}{|l|l|l|}
		\hline
		& Aktivit"aten                                                                                                 & Artefakte                                                                                  \\ \hline
		Product Owner    & Sprint Planning, Sprint Review                                                                               & \begin{tabular}[c]{@{}l@{}}Product Backlog, \\ auslieferbares Produkinkrement\end{tabular} \\ \hline
		ScrumMaster      & \begin{tabular}[c]{@{}l@{}}Sprint Planning, Sprint-Retrspektive, \\ Daily Scrum,\end{tabular}                & Sprint Backlog                                                                             \\ \hline
		Entwichlungsteam & \begin{tabular}[c]{@{}l@{}}Sprint Planning, Daily Scrum, \\ Sprint Review, Sprint-Retrospektive\end{tabular} & Sprint Backlog                                                                             \\ \hline
	\end{tabular}
\end{table}
