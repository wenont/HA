...
g.neue_relation("Benutzer", "schreibt", "Rezension", "(0,n)", "(1,1)")

g.neuer_knoten("Kommentar")
g.neue_relation("Rezension", "enthaelt", "Kommentar", "(0,n)", "(1,1)")
g.neues_attribut("Kommentar", "Freitext")
g.neues_attribut("Kommentar", "Datum")
g.neues_attribut("Rezension", "FortlaufendeNummer", primaer=True)
g.neue_relation("Kommentar", "antworten", "Kommentar", "(1,1)", "(0,n)")
g.neue_relation("Benutzer", "schreibt", "Kommentar", "(0,n)", "(1,1)")


g.neuer_knoten("Ort")
g.neue_relation("Rezension", "bezieht sich", "Ort", "(1,1)", "(1,1)")
