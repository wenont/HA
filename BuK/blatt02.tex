...
\subsection*{a)}
	...
	Sei $w_{l_1},\ w_{l_2},\ w_{l_3},\dots$ eine Abz"ahlung von $\bar{W}_{diag}$ mit einem regul"aren Ausdruck $r_k = (w_{l_1} + w_{l_2} + w_{l_3} + \dots )$ f"ur $k\in \mathbb{N}$, somit $\bar{W}_{diag} = L(r_k)$. Dazu gibt es auch ein entsprechendes Wort $w_k$.\\
